...
use Koha::Database;
use Koha::Items;
use Koha::Plugin::Com::ByWaterSolutions::EdifactRainbowBooks;
use Koha::Plugin::Com::ByWaterSolutions::EdifactRainbowBooks::Edifact::Order;
...
sub _new_plugin {
    my (%settings) = @_;
    my $plugin = Koha::Plugin::Com::ByWaterSolutions::EdifactRainbowBooks->new(
...
sub _build_edifact_order {
    ...
    return Koha::Plugin::Com::ByWaterSolutions::EdifactRainbowBooks::Edifact::Order
        ->new(
        {
